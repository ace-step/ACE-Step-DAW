...
const agentProjectStore = {
  getState: () => ({
    ...
    activePianoRollChordShape: useUIStore.getState().activeChordShape,
    setActivePianoRollTool: useUIStore.getState().setActivePianoRollTool,
    setActivePianoRollChordShape: useUIStore.getState().setActiveChordShape,
  ...
  getInitialState: () => ({
    ...
    activePianoRollChordShape: useUIStore.getInitialState().activeChordShape,
    setActivePianoRollTool: useUIStore.getInitialState().setActivePianoRollTool,
    setActivePianoRollChordShape: useUIStore.getInitialState().setActiveChordShape,
