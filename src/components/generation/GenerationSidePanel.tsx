        ...
        <div className="flex items-center gap-2 rounded-[18px] px-2 py-1.5" style={{ backgroundColor: 'rgb(35, 38, 43)', boxShadow: '0 8px 24px rgba(0,0,0,0.35)' }}>
          ...
          <div className="flex items-center gap-1 rounded-[14px] px-1 py-0.5" style={{ border: '1px solid rgb(56, 63, 76)' }}>
            <button
              ...
              className={`group relative flex h-9 w-9 items-center justify-center rounded-[12px] transition-all duration-200 ${
                loopBrowserOpen
            ...
            >
              ...
              <svg width="16" height="16" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.35" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          <div className="flex items-center gap-1 rounded-[14px] px-1 py-0.5" style={{ border: '1px solid rgb(56, 63, 76)' }}>
            ...
            >
              ...
              <svg width="16" height="16" viewBox="50 50 412 412" fill="currentColor" aria-hidden="true">
            ...
            <button
              ...
              className="group relative flex h-9 w-9 items-center justify-center rounded-[12px] text-zinc-400 transition-all duration-200 hover:bg-white/[0.06] hover:text-zinc-200"
              aria-label="Settings"
              title="Settings"
