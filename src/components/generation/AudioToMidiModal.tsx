...
export function AudioToMidiModal() {
  ...
  return (
    ...
    >
      <div role="dialog" aria-modal="true" aria-label="Convert to MIDI" className="w-[600px] max-w-[calc(100vw-24px)] rounded-xl border border-daw-border bg-daw-surface shadow-2xl text-xs text-zinc-200">
