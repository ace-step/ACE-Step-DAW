...
describe('loudnessMetering', () => {
  ...
  describe('kWeightingCoefficients', () => {
    it('returns stage1 and stage2 coefficients', () => {
      ...
      expect(coeffs.stage1).toEqual(expect.objectContaining({ b: expect.any(Array), a: expect.any(Array) }));
      expect(coeffs.stage2).toEqual(expect.objectContaining({ b: expect.any(Array), a: expect.any(Array) }));
