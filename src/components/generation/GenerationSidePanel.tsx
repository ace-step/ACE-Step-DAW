        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1 rounded-[12px] px-1.5 py-1.5" style={{ backgroundColor: 'rgb(35, 38, 43)', border: '1px solid rgb(56, 63, 76)', boxShadow: '0 8px 24px rgba(0,0,0,0.35)' }}>
            ...
            >
              ...
              <svg width="20" height="20" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.35" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            ...
            >
              ...
              <svg width="20" height="20" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.4" aria-hidden="true">
          ...
          <div className="flex items-center gap-1 rounded-[12px] px-1.5 py-1.5" style={{ backgroundColor: 'rgb(35, 38, 43)', border: '1px solid rgb(56, 63, 76)', boxShadow: '0 8px 24px rgba(0,0,0,0.35)' }}>
            ...
            >
              ...
              <svg width="20" height="20" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.45" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            ...
            >
              ...
              <svg width="20" height="20" viewBox="50 50 412 412" fill="currentColor" aria-hidden="true">
