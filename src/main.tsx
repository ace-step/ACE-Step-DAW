...
const agentProjectStore = {
  getState: () => ({
    ...
    setGenerationComparisonMode: useGenerationStore.getState().setGenerationComparisonMode,
    setGenerationModelOverride: useGenerationStore.getState().setGenerationModelOverride,
  ...
  getInitialState: () => ({
    ...
    setGenerationComparisonMode: useGenerationStore.getInitialState().setGenerationComparisonMode,
    setGenerationModelOverride: useGenerationStore.getInitialState().setGenerationModelOverride,
